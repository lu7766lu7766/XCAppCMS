      ...
      <div class="login login-v2" data-pageload-addclass="animated fadeIn">
        ...
        <div class="login-content">
          <div class="form-group m-b-20">
            <input type="text" class="form-control form-control-lg" placeholder="Email Address" required v-model="user.username" @keyup.13="doLogin()"/>
          </div>
            <div class="form-group m-b-20">
              <input type="password" class="form-control form-control-lg" placeholder="Password" required v-model="user.password" @keyup.13="doLogin()"/>
          </div>
...
export default {
	metaInfo: {
		...
		link: [
			...
			{ rel: 'stylesheet', href: '/resource/plugins/bootstrap-calendar/css/bootstrap_calendar.css' },
